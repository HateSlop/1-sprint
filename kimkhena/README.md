...
2. 검색: 검색할 데이터(예: 검색 쿼리)를 임베딩 모델을
 거쳐 벡터로 변환하고 벡터 데이 터베이스에서 검색한다.
3. 결과 반환: 벡터 데이터베이스에서는 검색 쿼리의 임베딩과 거리가 가까운 벡터를 찾 아 반환한다.

![그림 12.5 벡터 데이터베이스 작동 과정](kimkhena/png/photo_2024-09-26_09-49-58.jpg)
...
>벡터 데이터베이스 구분
![그림 12.7 벡터 데이터베이스 구분](kimkhena/png/photo_2024-09-26_09-50-00.jpg)
...
**재현율**은 실제 정답 데이터 중 검색 결과로 반환된 비율을 나타낸다. KNN 검색은 재현율이 100%이다.
 ...
 연산량이 데이터 수에 비례하게 늘어나 속도가 느려지는데 맞는지 확인하기 위해 100만개의 128차원 임베딩 데이터인 SIFTIM 데이터셋을 활용해 데이터 수가 증가할 때 검색 시간이 어떻게 달라지는지 확인해 보았다. 결과는 밑에 표와 같이 데이터가 늘어나면서 색인 시간이 증가하고 메모리 사용량도 약 97MB 정도 지속적으로 증가하는 것을 확인할 수 있다.
...
![그림 12.10 랜덤한 그래프(a)와 규칙적인 그래프(c) 사이의 작은 세계(b)](kimkhena/png/photo_2024-09-26_09-49-56.jpg)
...
![그림 12.15 스킵 리스트 작동 원리](kimkhena/png/photo_2024-09-26_09-49-52.jpg)

HNSW에는 이런 계층 구조가 접목되어 있다.

![그림 12.16 HNSW 계층 그림](kimkhena/png/photo_2024-09-26_09-49-54.jpg)
...
![그림 12.19 실습 흐름](kimkhena/png/photo_2024-09-26_09-50-04.jpg)
...
![그림 13.2 머신러닝 파이프라인](png/photo_2024-09-26_09-50-07.jpg)
...
![표 13.2 LLM을 최적화할 때 사용하는 방법](png/photo_2024-09-26_09-50-09.jpg)
...
![표 13.4 MT-Bench의 멀티 턴 질문 예시](png/photo_2024-09-26_09-50-12.jpg)
...
![그림 13.9 RAG의 세 가지 데이터와 평가](png/photo_2024-09-26_09-50-14.jpg)
...
![그림 14.2 얼티 오달 LLM의 구성요소](png/photo_2024-09-26_09-50-16.jpg)
...
![그림 14.5 CUP 모델 학습 방법: 대조](png/photo_2024-09-26_09-50-18.jpg)
...
![그림 14,6 CLIP 모델을 활용한 제로샷 추론](png/photo_2024-09-26_09-50-20.jpg)
...
![그림 14.10 물감이 물 전체로 퍼지는 확산 현상](png/photo_2024-09-26_09-50-23.jpg)
...
![그림 14.11 디퓨전 모델의 원리](png/photo_2024-09-26_09-50-25.jpg)
...
1[그림 14.15 DALL-E 2 모델 구조](png/photo_2024-09-26_09-50-30.jpg)
...
![그림 14.21 LLAVA 모델 구조](png/photo_2024-09-26_09-50-31.jpg)
...
![그림 14.22 LLaVA-1.5 모델 구조](png/photo_2024-09-26_09-50-33.jpg)
...
![그림 15.4 대표적인 도구 종류](png/photo_2024-09-26_09-50-35.jpg)
...
![그림 15.7 AutoGen이 지원하는 다양한 멀티 에이전트 형태](png/photo_2024-09-26_09-50-37.jpg)
...
![그림 15.9 사람이 LLM 에이전트를 평가하는 두 가지 방식](png/photo_2024-09-26_09-50-41.jpg)
...
![표 16.1 RNN과 트랜스포어 비교](png/photo_2024-09-26_09-50-43.jpg)
...
![그림 16.4 RNN과 LSTM 모델](png/photo_2024-09-26_09-50-45.jpg)
...
![표 16.4 아키텍처 비교](png/photo_2024-09-26_09-50-47.jpg)

## 16.5 코드로 보는 맘바

![그림 16.9 맘바 블록](png/photo_2024-09-26_09-50-47.jpg)
